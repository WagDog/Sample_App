...
* Database initialization
  The Heroku toolbelt for windows was installed. Then from the Ruby console, logged onto Heroku account by just typing Heroku login
  Once logged in, run the rake task db:migrate. i.e heroku run rake db:migrate --app <myHerokuAppName>
